...
//
//      2) 采样精度 8bit, signed char, 注意是 “有符号数”啊!! 千万别搞错了, 如果输入无符号数，哭去吧.. 
//
//      3) 每输入 50 个采样点就得到一次 DTMF 解码，历时 12.5ms, 国标要求 DTMF 码持续时间 >= 40ms, 因此连续解码的话可以得到连续3个相同码值，实际上，我就是这样提高抗干扰性的。 
//
//     4) 属于本人原创，请勿用作商用，否则保留追究权利。 
//
// by hendry, 2008/11 
//
